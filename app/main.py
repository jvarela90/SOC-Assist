...
from app.routes import chatbot as chatbot_routes, chatbot_api
...
app.include_router(chatbot_routes.router)   # Chat Analista — /chatbot/...
app.include_router(chatbot_api.router)      # Chat REST API  — /api/v1/chat/...
